...
SKIN.PrintName		= "Light Red Derma Skin"
SKIN.Author			= "manchyy"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "gwenskin/lightred.png" )
...
SKIN.fontCategoryHeader			= "LightRed"
...
derma.DefineSkin( "lightred", "LightRed epic skin", SKIN )
