...
local MainColor = Color(0, 150, 255)
local Color_MenuBG = Color(0, 0, 0, 200)
...
local BackgroundColorPrimary = Color(28, 32, 40)
local BackgroundColorSecondary = Color(39, 54, 77)
local BackgroundColorTertiary = Color(52, 71, 101)
...
function SKIN:PaintMenu(panel, w, h)
	...
	for i = 1, 8 do
		draw.RoundedBox(8 + i, -i, -i * 0.5, w + i *  2, h + i * 2, ShadowColor)
	end
	DisableClipping(old)
	draw.RoundedBox(8, 0, 0, w, h, BackgroundColorPrimary)
end
...
function SKIN:PaintPropertySheet(panel, w, h)
	...
	draw.RoundedBox(16, 0, Offset, w, h - Offset, Color_MenuBG)
end
...
function SKIN:PaintWindowCloseButton(panel, w, h)
	...
	draw.RoundedBoxEx(8, 0, 4, w, h - 8, bgColor, false, true, false, true)
...
function SKIN:PaintComboBox(panel, w, h)
	...
	elseif panel.Depressed or panel:IsMenuOpen() then
		return draw.RoundedBoxEx(8, 0, 0, w, h, MainColor, true, true)
	elseif panel.Hovered then
		bgColor = BackgroundColorTertiary
	end
...
derma.DefineSkin("midnight_sea", "Midnight Sea", SKIN)